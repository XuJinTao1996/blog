...
<body>
 ...
 <div class="body">  
  ...
  $con=mysql_connect("localhost","root","root");
    ...
    $sql="SELECT title,aticle,type,id FROM aticle where type='shi' LIMIT ".($page-1)*3 ." , 3";
   ...
   while ($rows=mysql_fetch_assoc($result)) {
    ...
    $total_sql="select COUNT(*) from aticle where type='shi' ";
    ...
    $next = $page+1;
    if ($page>1) {
     $page_banner.= '<a href="shi.php?p=1">首页</a>';
     $page_banner.= '<a href="shi.php?p='.$prev.'" >上一页&nbsp;&nbsp;</a>';    
  }  
    if($page<$total_pages){
    $page_banner.= '<a href="index.php?p='.$next.'">下一页&nbsp;&nbsp;</a>';
    $page_banner.= '<a href="shi.php?p='.$total_pages.'">末页</a>';}
  ...
  <div class="part1">
      ...
      <ul type="circle">
        ...
        <li><a href="life.php">人生轨迹</a></li><br>
        <li class="ul"><a href="">诗词歌赋</a></li><br>
      </ul>
  </div>
