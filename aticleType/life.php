...
<body>
 ...
 <div class="body">  
  ...
  $con=mysql_connect("localhost","root","root");
    ...
    $sql="SELECT title,aticle,type,id FROM aticle where type='life' LIMIT ".($page-1)*3 ." , 3";
   ...
   while ($rows=mysql_fetch_assoc($result)) {
    ...
    $total_sql="select COUNT(*) from aticle where type='life' ";
    ...
    $next = $page+1;
    if ($page>1) {
     $page_banner.= '<a href="life.php?p=1">首页</a>';
     $page_banner.= '<a href="life.php?p='.$prev.'" >上一页&nbsp;&nbsp;</a>';
    
  }  
    if($page<$total_pages){
    $page_banner.= '<a href="index.php?p='.$next.'">下一页&nbsp;&nbsp;</a>';
    $page_banner.= '<a href="life.php?p='.$total_pages.'">末页</a>';}
  ...
  <div class="part1">
      ...
      <ul type="circle">
        <li><a href="feel.php">个人心情</a></li><br>
        <li  class="ul"><a href="">人生轨迹</a></li><br>
        <li><a href="shi.php">诗词歌赋</a></li><br>
      </ul>
  </div>
