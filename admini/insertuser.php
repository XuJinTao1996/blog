...
<div  class="body">
	  ...
	  <ul>
          ...
          <ul>
            <li><a href="admini.php">账号重置/删除</a></li>
          	<li type="disc"><div class="select"><a href="insertuser.php" style="">添加账号</a></div></li>
          	</ul>
      	  	</li>
	...
	<div class="part2">
		 <?php 
           ...
           echo"<table class='table' border='1px'><tr><th>用户名</th><th>密码</th><th>权限</th></tr>";
           while($row = mysql_fetch_assoc($result)) {
           $id=$row['id'];
           echo '<tr><td>'.$row['userName'].'</td><td>'.$row['pwd'].'</td><td>'.$row['type'].'</td></tr>';}?>
           <tr><td colspan="3">
                  <a href="javascript:if(confirm('确认添加嘛！'))location='insert.php'">添加账号</a>
                  </td></tr>   
             <?php
