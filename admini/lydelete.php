...
<div  class="body">
	<div class="part1">
	  <ul>
	  	...
	  	<li type='circle'>账号管理
          <ul>
          	<li type="circle"><a href="admini.php" style="">账号重置/删除</a></li>
          	<li><a href="insertuser.php">添加账号</a></li>
          	</ul>
      	  	</li>
	  	<li type="circle">文章管理</li>
	  	  <ul>
	  	   	<li><a href="deleteAticle.php">文章删减</a></li>
	  	   	<li><a href="aticleUpdate.php">文章编辑</a></li>
	  	  </ul>
	  	<li type="disc">留言管理</li>
	  	   <ul>
            <li type="disc"><div class="select"><a href="lydelete.php">留言删除</a></div></li>
	...
	<div class="part2">
		 <?php 
           ...
           $sql='select * from ly LIMIT '.($page-1)*6 .' , 6';
           $result=mysql_query($sql);
           echo"<table class='table' border='1px'><tr><th>留言内容</th><th>留言作者</th><th>操作</th></tr>";
           while($row = mysql_fetch_assoc($result)) {
           	$ly_id=$row['ly_id'];
            echo '<tr><td>'.$row['ly_aticle'].'</td><td>'.$row['ly_author'].'</td>';?>
                  <td>
                  <a href="javascript:if(confirm('确认删除嘛！'))location='/blog/doaction.php?action=deletely&ly_id=<?=$ly_id?>'">删除留言</a></td>
                  </tr>
             <?php
          }
           echo "</table>";
