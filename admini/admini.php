...
<div  class="body">
	<div class="part1">
	  <ul>
	  	...
	  	<li>账号管理
          <ul>
          	<li type="disc"><div class="select"><a href="admini.php" style="">账号重置/删除</a></div></li>
	...
	<div class="part2">
		 <?php 
           ...
           $sql='select * from user LIMIT '.($page-1)*6 .' , 6';
           $result=mysql_query($sql);
           echo"<table class='table' border='1px'><tr><th>用户名</th><th>密码</th><th>权限</th><th colspan=2>操作</th></tr>";
           while($row = mysql_fetch_assoc($result)) {
           	$id=$row['id'];
            echo '<tr><td>'.$row['userName'].'</td><td>'.$row['pwd'].'</td><td>'.$row['type'].'</td>';?>
                  <td>
                  <a href="updataName.php?id=<?=$id?>">重置账号</a></td>
                  <td>
                  <a href="javascript:if(confirm('确认删除嘛！'))location='/blog/doaction.php?action=delete&id=<?=$id?>'">删除账号</a></td>
                  </tr>
             <?php
          }
           echo "</tale>";
